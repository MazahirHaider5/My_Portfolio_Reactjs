...
const socialLinks = [
  {
    href: "https://github.com/MazahirHaider5",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 2C7.037 2 3 5.887 3 10.667C3 12.797 3.85 14.733 5.266 16.18L4 21L8.92 19.77C9.872 20.106 10.914 20.333 12 20.333C16.963 20.333 21 16.447 21 11.667C21 6.887 16.963 2 12 2ZM12 3.5C16.084 3.5 19.5 6.772 19.5 11.0C19.5 15.228 16.084 18.5 12 18.5C11.042 18.5 10.118 18.322 9.266 17.987L8.9 17.843L6.3 18.5L6.98 16.021L6.758 15.74C5.596 14.257 5 12.53 5 10.667C5 6.772 7.916 3.5 12 3.5ZM9.42 8.667C9.266 8.667 9.038 8.7 8.846 8.9C8.654 9.1 8.15 9.58 8.15 10.467C8.15 11.355 8.77 12.21 8.866 12.343C8.962 12.477 10.234 14.5 12.23 15.267C13.902 15.913 14.33 15.78 14.77 15.733C15.21 15.687 16.084 15.233 16.276 14.78C16.468 14.327 16.468 13.94 16.42 13.86C16.372 13.78 16.23 13.727 15.99 13.627C15.75 13.527 14.742 13.027 14.49 12.94C14.238 12.853 14.058 12.813 13.878 13.073C13.698 13.333 13.31 13.78 13.154 13.96C12.998 14.14 12.842 14.16 12.602 14.06C12.362 13.96 11.59 13.7 10.79 12.993C10.15 12.427 9.744 11.713 9.588 11.453C9.432 11.193 9.566 11.02 9.666 10.92C9.754 10.831 9.884 10.667 9.984 10.527C10.084 10.387 10.124 10.287 10.184 10.14C10.244 9.993 10.204 9.86 10.154 9.76C10.104 9.66 9.698 8.86 9.52 8.58C9.6 8.58 9.52 8.667 9.42 8.667Z"
          fill="currentColor"
        />
      </svg>
    ),
